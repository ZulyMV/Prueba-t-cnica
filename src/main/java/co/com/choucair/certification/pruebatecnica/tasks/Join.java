...
public class Join implements Task {
  ...
  public Join(
      String strfirstname,
      String strlastname,
      String stremailadress,
      String strmonth,
      String strday,
      String stryear,
      String strlanguageuser) {
  ...
  public <T extends Actor> void performAs(T actor) {
    actor.attemptsTo(
        ...
        SelectFromOptions.byVisibleText(strday).from(UtestJoinPage.INPUT_DAY),
        ...
        Hit.the(Keys.ENTER).keyIn(UtestJoinPage.INPUT_LANGUAGE));
  }
}
